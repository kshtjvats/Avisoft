...
public class BankingSystem {
    ...
    public void transaction(BankingSystem bs, Scanner sc) throws AccountNotFound{
        try{
    ...
    public void transfer(BankingSystem bs, Scanner sc) throws AccountNotFound{
        try{
        System.out.println("Enter your account Number:");
        ...
        for(BankAccount account: bs.getBankAccounts())
            if(account.getAccountNumber().equals(recipientAccountNumber))
                recipient = account;
        if(recipient == null)
            throw new AccountNotFound("recipient not a bank account");
            BankAccount sender = null;
            for(BankAccount account: bs.getBankAccounts())
                if(account.getAccountNumber().equals(senderAccountNumber))
                    sender = account;
        if(sender == null)
            throw new AccountNotFound("sender not a bank account");
